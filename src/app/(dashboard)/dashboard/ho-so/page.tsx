...
import { PageHeader, primaryButtonClass, premiumCardClass } from '@/components/ui/page-header';
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <PageHeader
        ...
        actions={
          !isEditing ? (
            <Button size="sm" onClick={() => setIsEditing(true)} className={primaryButtonClass}>
